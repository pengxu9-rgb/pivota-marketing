            ...
            <div className="container-max space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3 pt-3">
                <a
                  ...
                  className="rounded-lg border border-input px-3 py-3 text-center text-sm font-medium tracking-tight text-foreground transition-colors hover:border-primary/60 hover:bg-primary/5"
                >
                  Developer Login
                </a>
                <a
