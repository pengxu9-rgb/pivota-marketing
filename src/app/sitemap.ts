...
const primaryRoutes = [
  ...
  { path: routePaths.makeProductsDiscoverable, changeFrequency: "weekly" as const, priority: 0.77 },
  { path: routePaths.doINeedToRebuildMyStore, changeFrequency: "weekly" as const, priority: 0.76 },
  { path: routePaths.startBeforeMerchantNativeCheckout, changeFrequency: "weekly" as const, priority: 0.75 },
  { path: routePaths.pivotaImplementationEffort, changeFrequency: "weekly" as const, priority: 0.74 },
